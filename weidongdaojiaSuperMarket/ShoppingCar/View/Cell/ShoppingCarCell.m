...
//    self.num = 0;
    ...
    self.selectBtn.rac_command = [[RACCommand alloc] initWithSignalBlock:^RACSignal * _Nonnull(id  _Nullable input) {
        ...
        self.selectGoodsBlock(self.selectBtn.isSelected);
    ...
    self.addBtn.rac_command = [[RACCommand alloc]initWithSignalBlock:^RACSignal * _Nonnull(id  _Nullable input) {
        ...
        weakSelf.addNumBlock([NSString stringWithFormat:@"%ld",weakSelf.num]);        
        return [RACSignal empty];
    }];
    self.reduceBtn.rac_command = [[RACCommand alloc] initWithSignalBlock:^RACSignal * _Nonnull(id  _Nullable input) {
        ...
        weakSelf.reduceNumBlock([NSString stringWithFormat:@"%ld",weakSelf.num]);
...
-(void)setModel:(GoodsActiveItem *)model{
    ...
    self.selectBtn.selected = model.goodsSelect;
    ...
    self.numLable.text =[NSString stringWithFormat:@"%@",model.goodsNum];
