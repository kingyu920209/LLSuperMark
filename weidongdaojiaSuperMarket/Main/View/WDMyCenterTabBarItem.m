...
@interface WDMyCenterTabBarItem ()
@property (strong, nonatomic) UIImageView *spotImageView;
@property (assign, nonatomic) BOOL tmpFlag;
@end
@implementation WDMyCenterTabBarItem
- (void)setupItem {
    [super setupItem];
    [self.mainImageView setImage:[UIImage imageNamed:@"shouye_icon_center"]];
    [self.titleLabel setText:@"个人中心"];
...
- (void)selectedAnim {
    [self.mainImageView setImage:[UIImage imageNamed:@"shouye_icon_selectCenter"]];
